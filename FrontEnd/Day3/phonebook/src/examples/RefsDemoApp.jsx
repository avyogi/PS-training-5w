...
//'refs' is a memeber of a react stateful component only
    ...
    render() {
        return (
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col">
                        <input type ="text" ref="username" className="form-control" placeholder ="Enter your name"/>
                    </div>
                    <div className="col">
                        <input type ="text" ref="city" className="form-control" placeholder ="Enter your city"/>
                    </div>
                </div>
                <br/>
