...
//	This is a configuration file (a substtitute for earlier XML configuration file)
//	This class defines beans (obejcts) that are loaded into the spring container
//	A bean is defined as a function returning the bean, and annotated as @Bean
@Configuration
